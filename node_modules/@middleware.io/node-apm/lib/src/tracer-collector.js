...
const init = (config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, helper_1.addVCSMetadata)(resourceAttributes);
    if (!apm_pause_traces) {
    ...
    if (hasExclusions || pyroscopeIgnoreHook) {
        instrumentationConfig["@opentelemetry/instrumentation-http"] = {
            ignoreOutgoingRequestHook: (request) => {
                ...
                if ((request === null || request === void 0 ? void 0 : request.path) && outgoingExcludedUrls.length > 0 && outgoingExcludedUrls.some((url) => request.path && request.path.includes(url))) {
            ...
            ignoreIncomingRequestHook: (request) => {
                ...
                if ((request === null || request === void 0 ? void 0 : request.url) && incomingExcludedUrls.length > 0 && incomingExcludedUrls.some((url) => request.url && request.url.includes(url))) {
